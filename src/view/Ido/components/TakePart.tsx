        ...
        >
          <PartStep bgType={3}>
            ...
            <div className="step-text">
              {" "}
              {t("Anyone can ido,Min buy is 100 $USDT and Max buy is 500 $USDT.")}
            </div>
          </PartStep>
        </Flex>
        <Flex
        ...
        >
          <PartStep bgType={2}>
            ...
            <div className="step-text">
              {" "}
              {t(
                "You can exchange other currencies into USDT on centralized or decentralized exchanges."
              )}{" "}
            </div>
          </PartStep>
          <PartStep bgType={1}>
            ...
            <div className="step-text">
              {" "}
              {t(
                "After IDO, you can claim and transfer $Lucky Angel to your wallet."
              )}{" "}
            </div>
          </PartStep>
        </Flex>
